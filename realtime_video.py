...
#emotion_model_path = 'models/Ensemble/MLCNN-128.hdf5'
...
EMOTIONS = ['anger','neutral','disgust','fear','happy','sadness','surprise']
...
vc = cv2.VideoCapture("emotion.mp4")
...
if __name__ == '__main__':
    ...
    while 1:
        ...
        cv2.putText(img_raw, fps_det, (10, 20),
        ...
        for b in dets:
            ...
            fW = b[2]
            fH = b[3]
            #roi = gray[fY+15:fH-15, fX+15:fW-15]
            roi = img_raw[fY+0:fH-0, fX+0:fW-0]
            ...
            for nf in range(10):
                if num_face == nf:
                   ...
                   cv2.moveWindow("ROI-{}".format(num_face), int(450+(num_face*250)),30)  
            ...
            for (i, (emotion, prob)) in enumerate(zip(EMOTIONS, preds)):
                ...
                cv2.moveWindow("Probabilities-{}".format(num_face), int(450+(num_face*250)),200)  
                #print(len(canvas))
